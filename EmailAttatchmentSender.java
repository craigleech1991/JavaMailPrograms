...
* only.
* 
* title: EmailAttatchmentSender.java
...
*              Can also send along an attatchment to be passed in via command line arguments. 
* @author craigleech
* @version 1.0
* @since 2018-06-28
*/
 ...
 * along with an attachment that can be passed in via command line arguments
 * 
 *</P>
 *<P>
 ...
 *<DD> Compile:    javac EmailAttatchmentSender.java</DD>
 *<DD> Run:        java EmailAttatchmentSender emailFile.txt</DD>
 *<DD> Document:   javadoc emailAttatchmentSender.java</DD>
 *</DL>
 */
 ...
 *
 *<P> 
 * public class EmailAttatchmentSender {<BR>
 * Private inner class
 *</P>
 *<P>
 ...
 *    If you wish to attactch a file, pass file name along as second command line argument
 * EXPECTED:
 ...
 *
 *   1. java EmailAttatchmentSender emailFile.txt
 ...
 *   2. java EmailAttatchmentSender emailFile.txt somefile.jpg
 *          If email is created successfully, emailFile.txt will be printed to the terminal.
 *          Success message will be printed to terminal if the email was succesfully sent.
 *          
 *           some.email.server
 ...
 *
 * ACTUAL:
 *    Results displayed as expected. Email is sent to all recipients, along with the desired attatchment
 *</P>
 *<P>
 * 3. Bad data cases:
 * EXPECTED:
...
/**Primary class for EmailAttatchmentSender*/
public class EmailAttatchmentSender {
/**
 ...
 * @param attatchment  the desired file you wish to attatch to the email
 ...
 */ 
    public void sendEmail(String server, String port,
            ...
            String subject, String message, File attatchment) throws AddressException,
            MessagingException {
        ...
        // creates a new session with a password authenticator
        ...
        // if user has not passed in any attachments via command prompt...
        if(attatchment == null){
        ...
        // else the user did pass ina file to be attatched....
        else{
            // set the from address
            msg.setFrom(new InternetAddress(user));
            // set the to address
            ...
            // now to create a message with many body parts
            // Create the message part
             ...
             // Now set the attachment
             messageBodyPart = new MimeBodyPart();
             // attachment is passed in as args[1].. will retrieve the path to this file.
             String filename = attatchment.getPath();
             DataSource source = new FileDataSource(filename);
             messageBodyPart.setDataHandler(new DataHandler(source));
             messageBodyPart.setFileName(filename);
             // add these parts to the body
             multipart.addBodyPart(messageBodyPart);
             // now add this multi part body to the message
    ...
    /* Main Method for EmailAttatchmentSender */
    public static void main(String[] args) {
        ...
        String ccList = "";
        String bccList = "";
        File attatchment = new File(args[1]);
        ...
        try (BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream(emailFile), "UTF-8"));) {
            ...
            // creatr a new HtmlEmailSender mailer
            EmailAttatchmentSender mailer = new EmailAttatchmentSender();
            // try to send email
            try {
                mailer.sendEmail(server, port, user, password, to, ccList, bccList, subject, message, attatchment);
